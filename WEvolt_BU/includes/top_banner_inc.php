...
<body>
<?php if ($HOME): ?>
<a href="https://secure.palmcoastd.com/pcd/eSv?iMagId=0815B&i4Ky=1118"><img src="/images/maxim-banner.jpeg" /></a>
<?php else: ?>
...
<?php /* <!-- AD TAG BEGINS: BarkIt(gr.barkit) / homepage / 300x250,300x600 -->
<? if ($_GET['home'] == 1) {?>
