 ...
 <div class="content_bg" id="content_wrapper">
         ...
         <table cellspacing="0" cellpadding="0" width="<? echo $SiteTemplateWidth;?>">
             <tr>
				...
				if (($_GET['r'] == 'success')&& (($_GET['type'] == 'fan')||($_GET['type'] == 'hosted'))) {?>
					   <div align="center">
                        <div class="spacer"></div>
...
<? if ($ShowShares == 1) {?>
<iframe src="/connectors/subscription_share.php?p=<? echo $_GET['p'];?>" scrolling="no" allowtransparency="true" frameborder="no" style="width:800px; height:500px;" /></iframe>
...
<center>
 <? if ($Finished == 1) {?>
        ...
        <div style="background-image: url(images/registration_toon.png); background-repeat:no-repeat; height:624px;width:627px; background-position:bottom center" align="center" class="messageinfo"> <div class="spacer"></div>
        <strong>Welcome to WEvolt, <span class="messageinfo"><? echo $Username;?>!</span></strong>
         <div class="spacer"></div>
        Thank you for registering on WEvolt.<br />
        
        Two emails have been sent to: <span class="messageinfo"><? echo $_POST['regemail'];?></span>
         <div class="spacer"></div>
...
<? } else {?>
		...
		<? if ($_GET['a'] != 'pro') {?>
               <img src="http://www.wevolt.com/images/register_info.png" border="0" usemap="#Map" />
<map name="Map" id="Map">
  <area shape="rect" coords="88,82,180,100" href="/login.php" />
</map>
                <div >
                ...
                <table width="75%"><tr><td class="blue_cell_title" width="125" align="right"  style="font-size:14px;"><strong>Username:</strong></td><td style="padding:3px;" align="left">
                ...
                <tr><td class="blue_cell_title" width="125" align="right"  style="font-size:14px;"><strong>Real Name:</strong></td><td style="padding:3px;" align="left">
                <input type="text" size="28" maxlength="50" name="realname"
                <?php if (isset($_POST['realname'])) { ?> value="<?php echo $_POST['realname']; ?>" <?php } ?>/></td>
                </tr>
                <tr><td class="blue_cell_title" width="125" align="right"  style="font-size:14px;"><strong>Email:</strong></td><td style="padding:3px;" align="left">
                ...
                <tr>
                <td class="blue_cell_title" width="125" align="right" style="font-size:14px;"><strong>Password:</strong></td><td style="padding:3px;" align="left">
                <input type="password" size="20" maxlength="15" name="password" style="background-color:#feeb7f; color:#000000;"/></td></tr>
                <tr>
                <td class="blue_cell_title" width="125" align="right" style="font-size:14px;"><strong>Confirm:</strong></td><td style="padding:3px;" align="left">
                <input type="password" size="20" maxlength="15" name="confirmpass" style="background-color:#feeb7f; color:#000000;"/></td></tr>
                <tr>
                <td class="blue_cell_title" width="125" align="right" style="font-size:14px;"><strong>OVER 18?</strong></td><td style="padding:3px;" align="left">
                ...
                <tr>
                <td class="blue_cell_title" width="125" align="right" style="font-size:14px;" colspan="2">If "Y" enter your birthdate:</td></tr>
                <tr>
                <td class="blue_cell_title" width="125" align="right" style="font-size:14px;"></td><td style="padding:3px;" align="left">
                <input type="text" size="8" maxlength="10" name="bdate" value="<?php if (isset($_POST['bdate'])) echo $_POST['bdate'];?>" /> (MM-DD-YYYY)</td></tr>
                 <tr>
                <td class="blue_cell_title" width="125" align="right" style="font-size:12px;">I authorize WEvolt to use this date of birth to enable me to view age-resitricted content</td><td style="padding:3px;" align="left">
                ...
                <tr>
                <td class="blue_cell_title" width="125" align="right" style="font-size:14px;"><strong>GENDER:</strong></td><td style="padding:3px;" align="left">
                <input type="text" size="2" maxlength="1" name="gender" value="<?php if (isset($_POST['gender'])) echo $_POST['gender'];?>" /> (M/F)</td></tr>
                  ...
                  <input type="image"  src="http://www.wevolt.com/images/register_yellow.png" style="border:none; background:none;">
                  </div>
                  </form>
        <? } else {?>
   ...
   <div align="left">
			   ...
			   function start_subscription(type,sid) {
                ...
                <img src="http://www.wevolt.com/images/pro_tour_1.gif" /><div class="spacer"></div>
                   <div  style="padding-left:300px;"><a href="/register.php?a=pro&page=2"> <img src="http://www.wevolt.com/images/yellow_next.gif" class="navbuttons"/></a></div>
                   
                    
                          <? }else if ($_GET['page'] == 2){?>
                           <div align="center">
                           <img src="http://www.wevolt.com/images/pro_tour_2.gif" /><div class="spacer"></div>
                 </div>
                             <div  style="padding-left:300px;"><a href="/register.php?a=pro&page=3"> <img src="http://www.wevolt.com/images/yellow_next.gif" class="navbuttons"/></a></div>
                    
                          <? }else if ($_GET['page'] == 3){
							  $query = "SELECT * from pf_subscriptions where UserID='".$_SESSION['userid']."' and (SubscriptionType ='hosted' or SubscriptionType ='hosted_no_ads') and Status='active'";
									$SubArray = $InitDB->queryUniqueObject($query);
									if ($SubArray->ID != '') { ?>
									  <div align="center">
                              			<img src="http://www.wevolt.com/images/pro_tour_3.gif" />
									<div class="spacer"></div><div class="spacer"></div>
                                    <? if ($_SESSION['userid'] == '') {?>
                                    
                                    Sorry you need to be logged in before you can sign up for a Pro Account. 
                                    
                                    <? } else {?>
											Says here that you've already got a pro account, so no reason to get another one!<div class="spacer"></div><div class="spacer"></div> If you're looking for a way to cancel the subscription, look for the link in your <a href="http://users.wevolt.com/<? echo $_SESSION['username'];?>/">MYvolt</a> settings under Subscriptions. 
                                            <? }?>
											</div>
							  <? } else {?>
                              <div align="center">
                             ...
                             <div class="spacer"></div>
                   <? if ($_SESSION['userid'] != '') {?><a  href="javascript:void(0);" onclick="start_subscription('pro','4');"> <img src="http://www.wevolt.com/images/go_pro_btn_yellow.gif" class="navbuttons"/></a>
                   <div class="spacer"></div>
                   <div class="spacer"></div>
				 			<img src="http://www.wevolt.com/images/pro_buy_blue.gif" />  
