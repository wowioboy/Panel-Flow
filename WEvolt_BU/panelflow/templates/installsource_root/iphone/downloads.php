...
$Smallbaseurl = 'images/downloads/desktops/320/';
$Largebaseurl = 'images/downloads/desktops/480/';
$DLDescription = stripslashes($download->Description);
	$deskstring .= "<div class='downloadimage'><img src='".$Smallbaseurl.$DlThumb."'  border='1' style='border-color:#000000;'></div><div class='dltitle'>".$Downname."</div><div class='dllink'><a href='../".$DlImage."' target='blank'>[download]</a><div class='spacer'></div>";
}
 
$coverstring = "";
$query = "select * from downloads where ComicID = '$ComicID' and DlType = 2";
$downloaddb->query($query);
$Smallbaseurl = 'images/downloads/covers/320/';
$Largebaseurl = 'images/downloads/covers/480/';
while ($download = $downloaddb->fetchNextObject()) { 
$DownID = $download->ID;
$Downname = $download->Name;
$DlType = $download->DlType;
