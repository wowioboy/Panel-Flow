...
$ProjectTableArray= $settingsdb->queryUniqueObject($query);
...
if ($ProjectType == 'comic') {
	...
	$ProjectArray= $settingsdb->queryUniqueObject($query);
...
$AdminUserArray= $settingsdb->queryUniqueObject($query);
...
$CreatorArray = $settingsdb->queryUniqueObject($query);
