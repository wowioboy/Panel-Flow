...
<head>
  ...
  <link href="http://famspam.com/facebox/faceplant.css" media="screen" rel="stylesheet" type="text/css" />
  <script src="http://famspam.com/facebox/jquery.js" type="text/javascript"></script>
  <script src="/panelflow/scripts/facebox/facebox.js" type="text/javascript"></script>
...
<body>
  <div id="main">
    <div id="shadow">
      <div id="content">
        <div id="logo">
          <img src="http://famspam.com/facebox/logo.png"/>
        </div>
        ...
        <div class="example">
          ...
          <p>
            <strong><a href="http://famspam.com/facebox/releases/facebox-1.2.tar.gz">Download Facebox v1.2</a></strong>
          </p>
        ...
        <div class="example">
          ...
          <p> <a href="http://famspam.com/facebox/stairs.jpg" rel="facebox">View '/facebox/stairs.jpg' in the Facebox</a> </p>
        ...
        <div class="example">
          ...
          <p> <a href="http://famspam.com/facebox/remote.html" rel="facebox">View 'remote.html' in the Facebox</a> </p>
        ...
        <div class="example">
          ...
          <div class="code">
            ...
            <code>
              &lt;script src="http://famspam.com/jquery.js" type="text/javascript"&gt;&lt;/script&gt;<br/>
              &lt;link href="http://famspam.com/facebox/facebox.css" media="screen" rel="stylesheet" type="text/css"/&gt;<br/>
        ...
        <div class="example">
          ...
          <ul id="screenshots">
            <li><a href="http://famspam.com/screenshots/photo.png" rel="facebox"><img src="screenshots/photo_small.png"></a></li>

            <li><a href="http://famspam.com/screenshots/error.png" rel="facebox"><img src="screenshots/error_small.png"></a></li>
            <li><a href="http://famspam.com/screenshots/success.png" rel="facebox"><img src="screenshots/success_small.png"></a></li>
            <li><a href="http://famspam.com/screenshots/preview.png" rel="facebox"><img src="screenshots/preview_small.png"></a></li>
          </ul>
          <p>
