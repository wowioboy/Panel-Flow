		...
		public function getSearch($Content, $Genre, $Keywords,$Sort, $Filter) {
			...
			if ($line->ProjectThumb != ''){
				...
				if ($line->ProjectType == 'forum') {
					...
					$ProjectURL = 'http://www.wevolt.com/project/'.$line->SafeFolder.'/';
				...
				if ($GenreArray != null) {
					while ($GCount <2) {
						...
						$GCount++;
							...
							echo "<td valign='top' style='padding:5px;'><div><table border='0' cellspacing='0' cellpadding='0' width='200'><tr><td id=\"updateBox_TL\"></td><td id=\"updateBox_T\"></td><td id=\"updateBox_TR\"></td></tr><tr><td class=\"updateboxcontent\"></td><td valign='top' class=\"updateboxcontent\"><table width='100%'><tr><td width='55'><a href='#' onclick='parent.window.location=\"".$ProjectURL."\";return false;'><img src='".$ProjectThumb."' border='0' alt='LINK' width='50' height='50'></a></td><td valign='top' onclick='parent.window.location=\"".$ProjectURL."\";return false;'\" class='navbuttons'><div class='sender_name'>".$HeaderTitle."</div><div class='messageinfo' style='font-size:10px;'>".$GenreList."<br/>Rank: ".$line->Ranking;
							if ($line->TotalFans != 0) 
								 echo "<br/>Fans: ".$line->TotalFans;
						 echo "</div></td></tr></table></td><td class=\"updateboxcontent\"></td></tr><tr><td id=\"updateBox_BL\"></td><td id=\"updateBox_B\"></td><td id=\"updateBox_BR\"></td></tr></table></div></td>";
				 $counter++;
					if ($counter == 3){
						echo "</tr><tr>";
						$counter = 0;
