...
if ($_GET['project'] == 'project.php') {
	include 'project_index.php';
	exit;
} 
if ($_GET['project'] == 'publisher') {
	include 'publisher_index.php';
	exit;
}
if ($_GET['project'] == 'user') {
...
$PageAreaWidth = $ProjectTemplate->PageAreaWidth;
$ContentSection->setPageAreaWidth($PageAreaWidth);
...
<img src="http://www.wevolt.com<? echo $ProjectThumb;?>" style="display:none;"/>
	...
	<tr><? if (($_SESSION['IsPro'] == 1) || ($_SESSION['ProInvite'] == 1)|| ($_SESSION['IsSuperFan'] == 1)|| ($IsProProject == 1)) {
				$_SESSION['noads'] = 1;
			$FlashHeight = 1;
	} else {
			$_SESSION['noads'] = 0;
        ...
        <td  valign="top" <? if (($_SESSION['sidebar'] == 'open') && (($_SESSION['IsPro'] != 1) && ($_SESSION['IsSuperFan'] != 1))) {?>align="left"<? } else {?> align="center"<? } ?> rowspan="2">
         ...
         <? }?>
			...
			if ((($_SESSION['overage'] == '') || (strtolower($_SESSION['overage']) == 'n')) && (($_SESSION['authage'] != 1) && ($Rating == 'a'))) {?>
   
				  <iframe src="" allowtransparency="true" width="728" height="90" frameborder="0" scrolling="no" name="top_ads" id="top_ads"></iframe>
        <div class="spacer"></div>
             <div id="pagediv" style="width:600px;" align="center">
                           <img src="http://www.wevolt.com/images/age_warning.jpg" border="0" usemap="#ageMap" />
              <map name="ageMap">
  <area shape="rect" coords="47,318,276,444" href="http://www.wevolt.com/">
  <area shape="rect" coords="327,314,559,447" href="http://www.wevolt.com/<? echo $SafeFolder;?>/?auth=1">
</map>
					</div>
...
function open_link(value,user) {
	if (value != '') {
		...
		<? $Description = preg_replace("/\r?\n/", "<br/>", $ContentSection->getProjectSynopsis());?> 
			jQuery.facebox('<div class="globalheader">synopsis</div><div class="infobox"><? echo addslashes($Description);?></div>');
			
		} else if (splitval == 'credits') {
		   jQuery.facebox('<div class="globalheader">credits</div><div class="infobox"><? echo addslashes($ContentSection->getCredits());?></div>');
     ...
     <iframe src="" allowtransparency="true" width="728" height="90" frameborder="0" scrolling="no" name="top_ads" id="top_ads"></iframe></center><div class="spacer"></div>
      <? } ?>
		...
		<? if (($_SESSION['comicheader'] != '') && ($_SESSION['comicheader'] != 'templates/skins/PFSK-00001/images/header_800x90.jpg')) {?>
            	<? if ($_SESSION['headerrollover'] != '') 
					$RollOveraction = 'onmouseover="this.src=\'http://www.wevolt.com/'.$_SESSION['headerrollover'].'\';" onmouseout="this.src=\'http://www.wevolt.com/'.$_SESSION['comicheader'].'\';"';
				?>
            	<a href="http://www.wevolt.com/<? echo $SafeFolder;?>/"><img src="http://www.wevolt.com/<? echo $_SESSION['comicheader'];?>" border="0" <? echo $RollOveraction;?>></a>
            <? }?>
              
              
 				<? $ContentSection->drawReaderBar();
				?>  <div class="spacer"></div>
                <div style="width:<? echo $_SESSION['contentwidth'];?>px;">
               ...
               <? $ContentSection->drawPageNav($ReaderTemplate);?>
                 ...
                 <div style="width:<? echo $ModuleWidth;?>px;" align="center">
