...
if ($search = $_REQUEST['search']) {
	...
	$query = "select 'comic' as type, title as name, thumb, genre as tag, SafeFolder as safefolder
			  from projects 
			  ...
			  union 
			  select 'user' as type, username as name, avatar as thumb, location as tag, username as safefolder
			  from users 
