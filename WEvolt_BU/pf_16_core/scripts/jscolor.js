...
var jscolor = {
	...
	dir : 'scripts/', // location of jscolor directory (leave empty to autodetect)
	...
	getDir : function() {
		if(!jscolor.dir) {
			...
			jscolor.dir = detected!=false ? detected : 'scripts/'
		}
		return jscolor.dir
	},
	...
	color : function(target, prop) {
		...
		function drawPicker(x, y) {
			...
			switch(modeID) {
				case 0: var padImg = '/pf_16_core/images/hs.png'; break
				case 1: var padImg = '/pf_16_core/images/hv.png'; break
			}
