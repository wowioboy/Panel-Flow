...
$_CONFIG['config_file_name']                      = 'rg_config';                                                                         // Name of this config file
...
$_CONFIG['redirect_url']                          = 'http://' . $_SERVER['HTTP_HOST'] . '/media_upload_finished.php';                                      // What page to load after the upload completes
