...
<div id='progressbar' class="messageinfo" style="display:none; padding-right:25px; padding-left:25px;padding-top:50px;padding-bottom:100px;" align="center"><strong>Please wait...</strong><div class='spacer'></div>
<div class="messageinfo" >Your (<span id='numberofpages'></span>) pages are being uploaded and processed. </div><div class='spacer'></div>This could take several minutes depending on the number of pages and size of images.
...
<div class='messageinfo_white'><strong>BATCH PAGE UPLOAD</strong></div><div style="height:10px;"></div>

<img src="http://www.wevolt.com/images/wizard_cancel_btn.png" onclick="window.location='/cms/edit/<? echo $_SESSION['safefolder'];?>/?tab=content&section=pages&series=<? echo $_GET['series'];?>';" class="navbuttons"/>
