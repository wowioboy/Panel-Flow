...
$query = "SELECT * from pf_media where StoryID='$StoryID' and FileType='image'";
$db->query($query);
...
$query = "SELECT * from pf_media where StoryID='$StoryID' and FileType='media'";
$db->query($query);
$MediaCount = 0;
...
$query = "SELECT * from pf_media where StoryID='$StoryID' and FileType='download'";
$db->query($query);
...
?>
<form action="/story/edit/<? echo $SafeFolder;?>/?section=pages&a=save&pageid=<? echo $PageID;?>" method="post">
<div align="center">
...
<textarea name="content" id="content" style="width:475px; height:600px;"><? echo $HtmlContent;?></textarea>
<div class="spacer"></div>
<?php
/*
...
<td valign="top" style="padding-left:10px; color:#FFFFFF" width="300"><div class="warning">PAGE SETTINGS</div> <br />
 Publish Date: (MM-DD-YYYY)<br/><input name="txtDatelive" id="txtDatelive" size="10" type="text" value="<? echo $PublishDate;?>">&nbsp;<img src="/<? echo $PFDIRECTORY;?>/images/cal.gif" onclick="displayDatePicker('txtDatelive',false,'mdy','-');" class="calpick"><div class="spacer"></div>
 
<input type="checkbox"  style="border:none;" name="txtEpisode" value="1" <? if ($Episode == 1) echo 'checked';?> onChange="toggleepisode();"/>Start Of Episode<input type="checkbox"  style="border:none;" name="txtChapter" value="1" <? if ($Chapter == 1) echo 'checked';?>/>Start Of Chapter<div class="spacer"></div>
