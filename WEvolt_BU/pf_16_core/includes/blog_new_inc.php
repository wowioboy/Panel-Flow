...
?>
<form action="/cms/edit/<? echo $SafeFolder;?>/?tab=content&section=blog&a=finish" method="post">
<div align="center">
...
<input type="submit" value ='SAVE' style="width:475px; background-color:#FF6600; color:#000000; font-weight:bold;border:1px #000000 solid;"/><div class="spacer"></div>
	
POST TITLE<br /></div>

<input type="text" style="width:475px; border:solid 1px #000000;"  name="txtTitle"/>
...
<td valign="top" style="padding-left:10px; color:#000000" width="300"><div class="warning">POST SETTINGS</div> <br />
 Publish Date: (MM-DD-YYYY)<br/><input style="border:solid 1px #000000;" name="txtDatelive" id="txtDatelive" size="10" type="text" value="<? echo date('m-d-Y');?>">&nbsp;<img src="/<? echo $PFDIRECTORY;?>/images/cal.gif" onclick="displayDatePicker('txtDatelive',false,'mdy','-');" class="calpick"><div class="spacer"></div>
