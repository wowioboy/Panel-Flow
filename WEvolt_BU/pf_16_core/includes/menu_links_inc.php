...
$query = "select * from menu_links where ComicID='$ComicID' ORDER BY Position ASC";
...
$menuString .= "<tr><td width='3%' align='left' class='listcell'><input type='radio' name='txtMenu' value='".$line->ID."'></td><td class='listcell'>".$line->Title."</td><td class='listcell'>".$line->Url;

if (($line->ContentID != 0) && ($line->ContentID != '')) {
	$menuString .= "&id=".$line->ContentID;
}

$menuString .= "</td><td class='listcell'>".$line->Window."</td></tr>";
