<? if ($EpisodeSetting == 1) { 
 if ($EpisodeCount > 0) { ?>
<div align="center"><a href="episodes.php" ><img src="/<? echo $PFDIRECTORY;?>/templates/<? echo $TEMPLATE;?>/images/episode_list.jpg" border='0'/></a></div>
<? } }?>
<? if ($ArchiveSetting == 1) { ?>
...
<div class="rightwrapper"> 
	 <div class="authornote"><img src="/<? echo $PFDIRECTORY;?>/templates/<? echo $TEMPLATE;?>/images/radiobtn.jpg" />COMIC CREDITS: </div>
