...
<tr><td width="<? echo $BoxWidth+25;?>"  valign="top" align="right" style="padding-left:15px;">
...
<? if ($PositionTwo == 1) { ?>
<td valign="top" <? $PositionFour == 1) echo 'rowspan="2"';?> align="center">
...
<td valign="top" <?  if ($PositionFour == 1) echo 'rowspan="2"';?> align="center">
	<? include str_repeat('../', $calling_dist - $include_dist + 1).$PFDIRECTORY.'/ads/position_two_inc.php';?>
</td>
<? }?>
...
<? if ($PositionFour == 1) { ?>
<td valign="top" align="center" >
	<? include str_repeat('../', $calling_dist - $include_dist + 1).$PFDIRECTORY.'/ads/position_four_inc.php';?>
</td>
<? }?>
</table>
