...
<tr>
	...
	<div class="authornote"><img src="images/radiobtn.jpg" />DESKTOP WALLPAPERS</div><div class="spacer"></div>
	<?php echo $deskstring; ?>
	</td>
...
<tr>
	<td id="modleftside"></td>
	<td class="boxcontent" valign="top">	
	 <div class="authornote"><img src="images/radiobtn.jpg" />COVER IMAGES </div><div class="spacer"></div>
		 <?php echo $coverstring; ?>
	</td>
	<td id="modrightside"></td>
</tr>
<tr>
...
<tr>
	<td id="modleftside"></td>
	<td class="boxcontent" valign="top">	
	 <div class="authornote"><img src="images/radiobtn.jpg" />AVATARS</div><div class="spacer"></div>
	  <?php echo $avatarstring; ?>
	</td>
	<td id="modrightside"></td>
</tr>
<tr>
