...
mysql_select_db ($userdb) or die ('Could not select database.');
 $query = "select * from $comicstable where title='$ComicName'";
...
<li><strong>URL: </strong><a href="<?php echo $Url;?>" target="blank"><?php echo $Url;?></a></li>
<li><strong>UPDATED: </strong><?php echo $Updated;?></li>
<li><strong>PAGES: </strong><?php echo $Pages;?></li>	

<li><table width="100%"><tr><td width="150"><a href="<?php echo $Url;?>" target="blank"><img src="<?php echo $Cover;?>" border="2" style='border-color:#000000; width:150px; height:200px;' ></a></td><td style="padding-left:2px;" valign="top"><a href="<?php echo $Url;?>" target="blank"><img src="/iphone/images/read_now.jpg" border="0" /></a><br/><br/><? if ($Userid == $_SESSION['userid']) { ?>
