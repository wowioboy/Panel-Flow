...
$story_array = array();
$counter = 0;
$query = "select * from comic_pages where ComicID = '$ComicID' and PageType='$Section' order by Position";
$pagesdb->query($query);
...
if ($insertComment == '1'){
 if( $_SESSION['security_code'] == $_POST['security_code'] && !empty($_SESSION['security_code'] ) ) {
		...
		if ($_POST['txtFeedback'] == ''){
			...
			Comment('Pages',$ComicID, $PageID, trim($_SESSION['userid']), $_POST['txtFeedback'],$db_database,$db_host, $db_user, $db_pass);
