...
$scripts = '	<script src="lib/prototype.js" type="text/javascript"></script> 
	...
	<script src="lib/cropper.js" type="text/javascript"></script><script src="lib/init_cropper/cover.js" type="text/javascript"></script>';
include 'header.php';
		...
		<div id="crop_save">
			<form action="last_step.php" method="post" class="frmCrop">
				<fieldset>
					...
					<input type="hidden" class="hidden" name="cropHeight" id="cropHeight" value="<?php echo $dimensions['height'] ?>" />				<input  type="hidden" name="txtUrl" value="<? echo $_POST['txtUrl'];?>" id="txtUrl" />
